...
export const PUBLIC_DEFAULTS: PublicSettings = {
  ...
  prompts: {
    man: [
      { section: "Asian-Inspired", name: "Korean Two-Block", description: "Korean two-block cut with longer 8 cm dark top, soft curtain fringe, hidden undercut sides visible around the ears, clean tapered nape, airy K-pop salon volume", imageUrl: L("men/korean-two-block.jpg") },
      { section: "Asian-Inspired", name: "Korean Wolf Cut", description: "Layered Korean wolf cut with choppy crown volume, wispy eyebrow fringe, textured sides, longer feathered nape reaching the neck, dark Seoul streetwear finish", imageUrl: L("men/korean-wolf-cut.webp") },
      ...
      { section: "Perms", name: "Men's Down Perm", description: "Korean down perm with straight side hair pressed flat and smooth against the head, natural lightly textured top, clean two-block outline, no side puff or frizz", imageUrl: L("men/mens-down-perm.jpg") },
      ...
      { section: "Modern Barbershop", name: "Edgar Cut", description: "Flat blunt fringe cut straight across the forehead, sharp square lineup at the temples, mid skin fade on the sides, compact textured top, modern barbershop shape", imageUrl: L("men/edgar-cut.jpg") },
      { section: "Modern Barbershop", name: "Slick-Back Pompadour", description: "Glossy 10 cm top combed up and back into strong pompadour volume, tight tapered fade, sharp shaved side part line, clean vintage barbershop finish", imageUrl: L("men/slick-back-pompadour.webp") },
      { section: "Modern Barbershop", name: "Textured French Crop", description: "Short forward-swept crop with piecey blunt fringe, choppy matte top about 4 cm, mid drop fade on sides and back, clean European barbershop silhouette", imageUrl: L("men/textured-french-crop.webp") },
      { section: "Modern Barbershop", name: "Classic Side Part", description: "Classic side part with 4 cm top combed smoothly to one side, visible clean part line, scissor-tapered sides, natural neckline, polished business finish", imageUrl: L("men/classic-side-part.jpg") },
      ...
      { section: "Short & Clean", name: "Buzz Cut", description: "Uniform 3 mm clipper length over the entire head, scalp lightly visible through the hair, clean natural hairline and neckline, completely flat with no styling volume", imageUrl: L("men/buzz-cut.webp") },
      ...
      { section: "Long & Textured", name: "Curly Afro Taper", description: "Defined springy coils with even rounded volume, clean tapered sideburns and neckline, compact natural black hair silhouette, hydrated separated curl texture", imageUrl: L("men/curly-afro-taper.webp") },
      { section: "Long & Textured", name: "Man Bun Undercut", description: "Long hair pulled tightly into a smooth bun at the back of the crown, shaved undercut from ear to ear, exposed temples and nape, clean gathered roots", imageUrl: L("men/man-bun-undercut.webp") },
      { section: "Long & Textured", name: "90s Curtain Hair", description: "Medium-to-long straight curtain hair parted in the middle, soft bangs framing both sides of the face, ear-covering length, slightly tousled 1990s finish", imageUrl: L("men/90s-curtain-hair.webp") },
      { section: "Edgy & Statement", name: "Mohawk", description: "Sides shaved down to skin from temple to nape, central strip of upright hair styled into strong vertical spikes, sharp geometric side silhouette", imageUrl: L("men/mohawk.jpg") },
      ...
      { section: "Curly & Coily", name: "Curly Burst Fade", description: "Defined natural curls on top with a curved burst fade wrapping around both ears, tapered neckline, rounded curl volume and clean side silhouette", imageUrl: L("men/curly-burst-fade.jpg") },
      ...
      { section: "Edgy & Statement", name: "Faux Hawk Fade", description: "Hair styled upward into a narrow textured ridge from forehead to crown, mid fade sides, short clean back, spiky matte finish without fully shaved mohawk sides", imageUrl: L("men/faux-hawk-fade.jpg") },
    ],
    woman: [
